...
inline Symbol operator"" _sym(const char* s, size_t) { return Symbol(s); }
...
namespace std {
template <>
struct hash<my_ai_training::ir::Symbol> {
  std::size_t operator()(my_ai_training::ir::Symbol s) const {
